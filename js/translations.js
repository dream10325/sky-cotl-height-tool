const translations = {
    'zh-Hant': {
        ...
        measurement_notice_body: "1. <b>資料格式：</b>由於遊戲產生的 QR code 資料格式多樣，非單純數字的計算無法取得詳細數字。<br>2. <b>本地端解碼：</b>本工具僅對官方網址進行本地端解碼，並非使用外掛程式連線伺服器抓取詳細資料，因此計算結果僅供參考。<br>3. <b>身高範圍：</b>本工具所採用的身高範圍為 0 至 14。",
        ...
        inst_4: "<b>方法一：直接上傳截圖</b><br>回到本工具網頁，點擊「選擇圖片」按鈕，或直接將截圖檔案拖曳至上傳區域。",
        inst_5: "<b>方法二：貼上網址</b><br>使用另一部手機或網頁掃碼工具讀取你的截圖，掃描後會得到一串以 <code>https://sky.thatg.co/o=</code> 開頭的網址。<b>複製整個網址</b>並貼到本工具的輸入框即可。",
