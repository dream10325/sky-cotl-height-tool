const translations = {
    'zh-Hant': {
        ...
        ambiguous_warning: "⚠️ 此 QR Code 使用了壓縮格式，正負號資訊已遺失。這是官方 QR Code 的已知問題，並非工具錯誤。以下顯示兩種可能結果，請自行比對遊戲內身高判斷哪個正確。",
        ambiguous_positive_label: "可能身高 ①:",
        ambiguous_negative_label: "可能身高 ②:"
    },
    'en': {
        ...
        ambiguous_warning: "⚠️ This QR Code uses a compressed format where the scale sign has been lost. This is a known issue with the official QR Code format, not a bug in this tool. Two possible results are shown below — please compare with your in-game height to determine which is correct.",
        ambiguous_positive_label: "Possible Height ①:",
        ambiguous_negative_label: "Possible Height ②:"
    },
    'ja': {
        ...
        sim_result_label: "新しい身長（シミュレーション）:",
        ...
        ambiguous_warning: "⚠️ このQRコードは圧縮形式を使用しており、スケールの符号情報が失われています。これは公式QRコードの既知の問題であり、ツールのバグではありません。2つの候補結果を表示しますので、ゲーム内の身長と比較してどちらが正しいか確認してください。",
        ambiguous_positive_label: "候補身長 ①:",
        ambiguous_negative_label: "候補身長 ②:"
    }
};