...
document.addEventListener('DOMContentLoaded', () => {
    ...
    dom.calculateBtn.addEventListener('click', () => {
        ...
        if (results.error) {
            ...
            dom.resetSimBtn.click(); // Reset simulator on new calculation
    ...
    dom.drinkPotionBtn.addEventListener('click', () => {
        ...
        dom.potionResult.textContent = newHeightNumber.toFixed(4);
        potionCounter++;
